...
void SearchEngine::initialize()
{
    ...
    cout << "============================================" << endl;
    cout << "   FlashSearch Engine v1.0 (Multithreaded)  " << endl;
    cout << "============================================" << endl;
    ...
    cout << "TOTAL INITIALIZATION TIME: " << diff.count() << " seconds" << endl;
}
...
void SearchEngine::build_index_batch(const vector<string> &filesupdate)
{
    for (auto filename : filesupdate)
    {
        ...
        unordered_map<string, int> localdocmap;
...

        {
            ...
            for (auto const &[word, count] : localdocmap)
            {
